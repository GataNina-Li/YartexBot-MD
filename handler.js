       ...
       case 'add':
        case 'remove':
            if (chat.welcome) {
                ...
                this.sendFile(id, apii.data, 'pp.jpg', text, null, false, { contextInfo: { externalAdReply: { showAdAttribution: false, title: 'CuriosityBot-MD', body: global.wm, sourceUrl: global.ig, thumbnail: imagen3 }}, mentions: this.parseMention(text) })                        
                   }
                }
            }
            break
