       ...
       case 'add':
        case 'remove':
            if (chat.welcome) {
			   ...
			   this.sendMessage(m.chat, { text: text, contextInfo:{ forwardingScore: 9999999, isForwarded: true, mentionedJid:[m.sender], "externalAdReply": { "showAdAttribution": true, "renderLargerThumbnail": true, "thumbnail": pp, "title": `CuriosityBot-MD`, "containsAutoReply": true, "mediaType": 1, "mediaUrl": nn, "sourceUrl": nn }}})
