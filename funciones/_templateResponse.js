...
continue
if (!opts['restrict'])
if (funcion.tags && plugin.tags.includes('admin'))
continue
...
let _prefix = funcion.customPrefix ? funcion.customPrefix : this.prefix ? this.prefix : global.prefix
...
let isId = funcion.command instanceof RegExp ? // RegExp Mode?
