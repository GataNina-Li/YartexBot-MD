...
let image = await new can.Rank().setAvatar(ppBot).setUsername(name ? name.replaceAll('\n','') : '-').setBg('https://i.ibb.co/Wn9cvnv/FABLED.png').setNeedxp(wm).setCurrxp(`${user.exp}`).setLevel(`${user.level}`).setRank('https://telegra.ph/file/55128ea6d59fe9eb50c0e.jpg').toAttachment()
