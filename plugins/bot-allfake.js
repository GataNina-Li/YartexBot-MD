...
global.fake = { contextInfo: { mentionedJid: conn.parseMention(wm), forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363302472386010@newsletter', serverMessageId: '', newsletterName: 'YartexBot-MD 🍓' }, externalAdReply: { title: packname, body: `👋 Hola! ` + nombre, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: fotos, thumbnail: fotos, sourceUrl: enlaces }}}, { quoted: m } //fake con reenviado de canal
}
