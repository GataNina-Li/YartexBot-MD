...
await conn.reply(m.chat, '*Próximamente se remitirá el menú.*', fliveLoc, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '👋 Hola!!', body: saludo, sourceUrl: global.ig, thumbnailUrl: ppBot }}})
m.react('🚀') 
