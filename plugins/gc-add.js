...
const handler = async (m, {conn, text, participants, args}) => {
  ...
  try {
    ...
    for (const user of participant.filter((item) => item.attrs.error == 403)) {
      ...
      const teks = `*ɴᴏ ғᴜᴇ ᴘᴏsɪʙʟᴇ ᴀɴ̃ᴀᴅɪʀ ᴀ @${jid.split('@')[0]}, ᴇsᴛᴏs ᴘᴜᴇᴅᴇ ᴏᴄᴜʀʀɪʀ ᴘᴏʀǫᴜᴇ ᴇʟ ɴᴜ́ᴍᴇʀᴏ ᴇsᴛᴇ ɪɴᴄᴏʀʀᴇᴄᴛᴏ, ʟᴀ ᴘᴇʀsᴏɴᴀ sᴇ ʜᴀ sᴀʟɪᴅᴏ ʀᴇᴄɪᴇɴᴛᴇᴍᴇɴᴛᴇ ᴅᴇʟ ɢʀᴜᴘᴏ ᴏ ʟᴀ ᴘᴇʀsᴏɴᴀ ʜᴀʏᴀ ᴄᴏɴғɪɢᴜʀᴀᴅᴏ sᴜs ᴘʀɪᴠᴀᴄɪᴅᴀᴅ ᴅᴇ ɢʀᴜᴘᴏs, sᴇ ʟᴇ ᴇɴᴠɪᴏ́ ʟᴀ ɪɴᴠɪᴛᴀᴄɪᴏ́ɴ ᴀʟ ɢʀᴜᴘᴏ ᴇɴ sᴜ ᴘʀɪᴠᴀᴅᴏ ᴀʟ ᴜsᴜᴀʀɪᴏ*`;
      m.reply(teks, null, {mentions: conn.parseMention(teks)});
      const captionn = `Hey!! Hola, me presento, soy CuriosityBot-MD 🌺, y soy un Bot para WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te agregues, te esperamos!!`;
