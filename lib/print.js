...
console.log(`
𝄢 ꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷✧༄
❚ ▸ 𝐁𝐎𝐓 ❱❱ ${chalk.bgMagenta(chalk.white.italic('%s'))}
❚ ▸ 𝐇𝐎𝐑𝐀𝐑𝐈𝐎 ❱❱ ${chalk.black.bgGreen('%s')}
❚ ▸ 𝐀𝐂𝐂𝐈𝐎𝐍 ❱❱ ${await formatMessageStubType(m.messageStubType, name_user)}
❚ ▸ 𝐔𝐒𝐔𝐀𝐑𝐈𝐎 ❱❱ ${chalk.white('%s')} / ${chalk.bgMagentaBright.bold(user.role.replace(/\*/g, ''))} / Premium » ${user?.premiumTime > 0 ? '✅' : '❌'}
❚ ▸ 𝐑𝐄𝐂𝐔𝐑𝐒𝐎𝐒 ❱❱ ${chalk.yellow('%s%s')}
❚ ▸ %s
❚ ▸ 𝐏𝐄𝐒𝐎 ❱❱ ${chalk.red('%s (%s %sB)')}
❚ ▸ 𝐓𝐈𝐏𝐎 ❱❱ ${chalk.bgBlueBright.bold('[%s]')}
𝄢 ꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷✧༄`.trim(),          
...
(m.chat.includes("@g.us") ? `𝐆𝐑𝐔𝐏𝐎 ❱❱ ${chalk.magentaBright(`${m.chat} ~${chat}`)}` : `𝐏𝐑𝐈𝐕𝐀𝐃𝐎 ❱❱ ${chalk.greenBright(`${m.sender} ~${user.name ? user.name : conn.getName(m.sender)}`)} `),
filesize,
