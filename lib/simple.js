...
return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: null, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363302472386010@newsletter', newsletterName: global.author, serverMessageId: '', }, forwardingScore: 1, externalAdReply: { title: packname, body: 'Bot de WhatsApp con tematica Yaoi/Bl hecho por fans para fans.', previewType: `PHOTO`, thumbnailUrl: 'https://telegra.ph/file/3f00e26dcd5dcd09a68a1.jpg', sourceUrl: md, mediaType: 1, renderLargerThumbnail: false, ...options }}}, { quoted, ...options })
}
},
	sendContactArray: {
            async value(jid, data, quoted, options) {
