...
/**
    ...
    */
    sendPoll: {
            async value(jid, name = '', optiPoll, options, quoted) {
        ...
        options: optiPoll.map(btn => ({
              ...
              return conn.sendMessage(jid, {pollCreationMessage: pollMessage}, { quoted }) //return conn.relayMessage(jid, { pollCreationMessage: pollMessage }, { ...options });
                }
        },
        //--
        sendHydrated: {
