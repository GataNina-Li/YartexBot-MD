...
return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: null, forwardedNewsletterMessageInfo: { newsletterJid: randomChannel.id, serverMessageId: '', newsletterName: randomChannel.nombre }, forwardingScore: 999, isForwarded: true, ...options }}, { quoted, ...options })
}
},
	sendContactArray: {
            async value(jid, data, quoted, options) {
