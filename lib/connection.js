...
async function connectionUpdate(update) {
    ...
    this.sendMessage(`593993684821@s.whatsapp.net`, {image:{url: img}, caption: `HOLA MI CREADOR ME CONECTADO COMO UN NUEVO BOT 😎`}, { ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100} )
}
waitTwoMinutes()
